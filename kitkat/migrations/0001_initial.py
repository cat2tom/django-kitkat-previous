    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expected_reading_6MV', models.FloatField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('test_name', models.CharField(default=b'Fred', max_length=50)),
                ('frequency', models.CharField(default=b'Fred', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='QATestResult',
